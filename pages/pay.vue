<template>
  <NuxtLayout name="public">
    <div class="max-w-5xl mx-auto text-center mt-20 space-y-4 space-x-2">
      ...
      <div v-if="result?.data?.data" class="mt-6 text-center space-y-6 text-gray-700 dark:text-white">
        ...
        <!-- QR CODE -->
        <img :src="result.data.data.qr_url" alt="QR Code Pembayaran" ref="qrImage"
        ...
        <div v-if="result.data.data.instructions?.length" class="text-left max-w-md mx-auto space-y-4">
          ...
          <div v-for="(instruction, idx) in result.data.data.instructions" :key="idx"
